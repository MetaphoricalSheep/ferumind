...
do not touch the filesystem or the database; :mod:`lattice.core.writes` owns
...
from lattice.core.edit_targets import (
    ExactEdit,
    ExactMatch,
    FindMode,
    InsertAnchor,
...
def prepare_frontmatter_patch(
    ...
    *,
    ...
    if protected:
        raise FrontmatterProtectedError(
            f"Frontmatter keys {protected} are managed by Lattice and cannot be edited",
