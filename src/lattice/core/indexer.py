...
from lattice.core.documents import ParsedDocument, parse_document
from lattice.core.locks import acquire_project_lock
from lattice.core.paths import contained_path, contained_project_root
...
def _should_skip(rel_path: Path) -> bool:
    """Skip hidden files and ``.lattice`` internals during indexing."""
