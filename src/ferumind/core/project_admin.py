...
from ferumind.core.operations import WORKSPACE_OPERATION_PROJECT
from ferumind.core.paths import WorkspaceRoot, contained_path
from ferumind.core.registry import load_registry, remove_registry_entry, validate_project_key
...
def delete_project(conn: DbConnection, workspace: WorkspaceRoot, key: str) -> DeleteProjectResult:
    ...
    Ferumind never hard-deletes live knowledge content. A still-present project
