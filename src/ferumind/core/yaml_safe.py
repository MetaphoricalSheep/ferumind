"""Resource-bounded YAML loading for Ferumind-controlled data shapes."""
...
class YamlSafetyError(yaml.YAMLError):
    """Raised when YAML exceeds Ferumind's safe structural subset."""
...
def safe_load_yaml(
    ...
    *,
    ...
    Ferumind YAML does not need anchors, aliases, or non-string mapping keys.
