"""Ferumind MCP server — FastMCP assembly and entry point (spec-mcp v2).
...
from ferumind.mcp.input_validation import apply_strict_input_validation
...
from ferumind.mcp.tool_context import init_tool_context
from ferumind.mcp.write_tools import register_write_tools
...
mcp = FastMCP(name="Ferumind", instructions=INSTRUCTIONS)
